...
| constraints.maxSize | optional   | [1-9][0-9]{0,3}(KB&#124;MB) e.g. 1024KB, Maximum size 250MB |  25MB  | Maximum Size (sum of files' sizes) for the envelope (ceiling is 25MB)  | 
| constraints.maxSizePerItem | optional   |  [1-9][0-9]{0,3}(KB&#124;MB) e.g. 1024KB, Maximum 100MB |  10MB  | Maximum Size for each file (ceiling is 10MB)  | 
