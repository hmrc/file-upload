...
**If your service needs to submit to DMS, please use [dms-submission](https://github.com/hmrc/dms-submission)**
...
For the majority of envelopes, this will make the envelope available to polling (See [transfer](#transfer) below).
For those configured for Push (destination DMS), this will send the message to the registered push endpoint (See [push](./docs/push.md) for more detils).
