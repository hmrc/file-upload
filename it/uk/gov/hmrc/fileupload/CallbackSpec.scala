...
class CallbackSpec extends IntegrationSpec with EnvelopeActions with EventsActions with FileActions with Eventually with FakeConsumingService with FakeAuditingService {
