...
case class CreateEnvelope(id: EnvelopeId,
                          ...
                          constraints: Constraints) extends EnvelopeCommand
...
case class EnvelopeCreated(id: EnvelopeId, callbackUrl: Option[String], expiryDate: Option[DateTime], metadata: Option[JsObject], constraints: Constraints) extends EnvelopeEvent
