...
case class CreateEnvelope(id: EnvelopeId,
                          ...
                          constraints: EnvelopeConstraints) extends EnvelopeCommand
...
case class EnvelopeCreated(id: EnvelopeId, callbackUrl: Option[String], expiryDate: Option[DateTime], metadata: Option[JsObject], constraints: EnvelopeConstraints) extends EnvelopeEvent
